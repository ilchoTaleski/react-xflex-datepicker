...
exports.take = exports.naturalNumbers = exports.generateNumbers = void 0;
var generateNumbers = function (from, to) {
    ...
    return __spread(exports.take(count, exports.naturalNumbers(num)));
};
...
var take = function (n, iterable) {
    var index, iterable_1, iterable_1_1, val, e_1_1;
    var e_1, _a;
