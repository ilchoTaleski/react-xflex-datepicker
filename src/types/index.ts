import { Locale, Moment, MomentFormatSpecification } from 'moment';
...
export interface IDatepickerProps {
    ...
    onChooseDate?: (e: { date: Moment }) => void;
    onClearDate?: (e: { date: Moment }) => void;
    onCalendarShow?: () => void;
    onCalendarHide?: () => void;
    onMonthDayOver?: (e: { date: Moment }) => void;
}
...
export interface IDatepickerRangeProps {
    ...
    placeholder?: string;
    buttonControlClassName?: string;
    onChooseDate?: (e: { start: Moment; end: Moment }) => void;
    onClearDate?: (e: { start: Moment; end: Moment }) => void;
    onCalendarShow?: () => void;
    onCalendarHide?: () => void;
    onMonthDayOver?: (e: { date: Moment }) => void;
    hasTooltip?: boolean;
